    ...
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 py-8'>
      ...
      <Card className='border-border bg-gradient-to-br from-primary/5 to-primary/10'>
        ...
        <CardContent className='text-center max-w-2xl mx-auto'>
          <p className='text-muted-foreground'>{t('dashboard.content')}</p>
        </CardContent>
      </Card>
      ...
      <div className='grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4'>
        <Card className='border bg-card/30'>
          ...
          <CardContent className='pt-2'>
            <div className='text-3xl font-bold mb-1'>
              {systemOverview?.enabled_services || 0}
            </div>
            <p className='text-xs text-muted-foreground'>
              {t('dashboard.activeServicesDesc')}
            </p>
          </CardContent>
        </Card>
        ...
        <Card className='border bg-card/30'>
          ...
          <CardContent className='pt-2'>
            <div className='text-3xl font-bold mb-1'>
              {systemOverview?.today_total_requests || 0}
            </div>
            <p className='text-xs text-muted-foreground'>
              {t('dashboard.todayRequestsDesc')}
            </p>
          </CardContent>
        </Card>
        ...
        <Card className='border bg-card/30'>
          ...
          <CardContent className='pt-2'>
            ...
            <p className='text-xs text-muted-foreground'>
              {t('dashboard.remainingCreditsDesc')}
            </p>
          </CardContent>
        </Card>
      </div>
                ...
                <div className='flex items-center'>
                  <span className='text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded-full'>
                    {systemStatus?.start_time
                      ? formatUptime(systemStatus.start_time)
                      : t('dashboard.unknown')}
                  </span>
                </div>
              </div>
                ...
                <Button
                  ...
                  <div className='text-left'>
                    <p className='font-medium'>
                      {t('dashboard.installService')}
                    </p>
                    <p className='text-xs text-muted-foreground'>
                      {t('dashboard.installServiceDesc')}
                    </p>
                  </div>
                </Button>
              )}
